...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20220110202506_addClassIdColumnIntoSubjectWithUniqueIndex")]
    partial class addClassIdColumnIntoSubjectWithUniqueIndex
    {
            ...
            modelBuilder.Entity("Domain.Entities.Subject", b =>
                {
                    ...
                    b.HasIndex("TimetableId", "Name", "ClassId")
                        .IsUnique()
                        .HasFilter("[TimetableId] IS NOT NULL AND [Name] IS NOT NULL AND [ClassId] IS NOT NULL");
